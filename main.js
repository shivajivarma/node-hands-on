...
/**
* ExpressJS
**/console.log("\n\n3. ExpressJS: Routing & Interceptors")
...
myApp.get('/', function(req,res,next){console.log("Single Interceptor on '/'"); next()},
				function(req,res){
...
birdsRouter.get('/1', function(req,res,next){console.log("Single Interceptor on '/birds/1'"); next()},
				function(req,res){
					res.send("1 is parrot");
				});
birdsRouter.get('/2', function(req,res,next){console.log("Single Interceptor on '/birds/2'"); next()},
				function(req,res){
					res.send("2 is crow");
				});
...
myApp.listen(3000, function () {console.log('Example app listening on port %s', this.address().port)});
